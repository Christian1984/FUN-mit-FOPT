...
public class JetrisFxStatsView implements JetrisView {
    ...
    public void modelChanged() {
        Runnable r = new Runnable() {
            @Override
            public void run() {
                scoreLabel.setText("Score: " + jetrisGame.getScore());
                levelLabel.setText("Level: " + jetrisGame.getLinesCleared());
                linesClearedLabel.setText("Lines cleared: " + jetrisGame.getLinesCleared());
            }
        };
